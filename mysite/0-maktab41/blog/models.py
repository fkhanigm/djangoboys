...
#from django.contrib.auth.models import User    #this user use when we does not use account app, and 'AUTH_USER_MODEL' in settings.
from django.conf import settings
#evry where we use 'ForeignKey' our 'User' we shoud use 'settings.AUTH_USER_MODEL'
